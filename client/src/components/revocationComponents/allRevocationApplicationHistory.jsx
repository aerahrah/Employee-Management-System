...
// ✅ Fix 1: Import keepPreviousData for React Query v5
...
const ApplicationActionMenu = ({
  ...
  const isCTO = leaveTypeFilter === "CTO";
    ...
    >
      <div className="p-4 transition-colors duration-300 ease-out">
        ...
        <div className="mt-4 grid grid-cols-2 gap-2">
          ...
          >
            ...
            >
              ...
              {isCTO ? "Revoked Hours" : "Total Days"}
            </div>
            <div
        ...
        >
          ...
          <span className="truncate">{coveredCount} day(s) revoked</span>
        </div>
      </div>
...
const AllRevocationApplicationHistory = () => {
  ...
  // ---- Filters / pagination ----
  const [leaveTypeFilter, setLeaveTypeFilter] = useState("CTO"); // Toggle between CTO & Wellness
  ...
  const { data, isLoading } = useQuery({
    queryKey: [
      "allRevocationRequests",
      leaveTypeFilter, // Critical: this forces refetch when swapping CTO/Wellness
      page,
      limit,
      statusFilter,
      debouncedSearch,
    ...
    queryFn: () => {
      ...
      // Ensure fetchWellnessRevocationRequests is properly exported from your wellness API!
      return leaveTypeFilter === "CTO"
        ? fetchRevocationRequests(params)
        : fetchWellnessRevocationRequests(params);
    },
    // ✅ Fix 2: Proper syntax for React Query v5
        ...
        >
              ...
              <div className="flex flex-col 2xl:flex-row 2xl:items-start justify-between gap-4">
                <div className="flex items-start gap-4 flex-1 min-w-0">
                  <div className="min-w-0">
                    ...
                    <p
                      ...
                      style={{ color: "var(--app-muted)" }}
                    >
                      View and manage all CTO and Wellness revocation requests
                    </p>
                  </div>
                </div>
                ...
                <div className="w-full lg:w-auto">
                  <div className="grid grid-cols-2 md:grid-cols-4  gap-3 items-stretch">
                    <StatCard
                      title="Total Revocations"
                      value={String(totalRequests || 0)}
                      icon={LayoutGrid}
                      hint={`All ${leaveTypeFilter} requests`}
                      tone="blue"
                      borderColor={borderColor}
                    />
                    <StatCard
                      ...
                      <table className="w-full text-left">
                        ...
                        >
                          ...
                          >
                            ...
                            <th className="px-6 py-4">Dates Revoked</th>
          ...
          >
            <MemoList
              ...
              description={`Read-only view of memos attached to this revocation request.`}
            />
          </Modal>
        </SkeletonTheme>
      </div>
...
export default AllRevocationApplicationHistory;
