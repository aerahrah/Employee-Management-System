...
const MyWellnessApplications = () => {
  ...
  const canManageSelf = can("wellness.manage_self");

  // ✅ Check revocation permission and globally enabled settings
  ...
  const tabs = [
    ...
    },
    {
      ...
      label: "Cancelled",
      icon: Ban,
      count: (statusCounts.CANCELLED || 0) + (statusCounts.REVOKED || 0),
      tone: "slate",
    },
  ];
