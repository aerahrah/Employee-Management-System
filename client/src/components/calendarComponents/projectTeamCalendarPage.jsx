...
import { getProjectTeamEvents } from "../../api/calendar"; // Updated API import
...
const ProjectTeamCalendarPage = () => {
  ...
  const {
    ...
    queryKey: ["project-calendar-events"],
    queryFn: async () => {
      const res = await getProjectTeamEvents();
  ...
  const handleRefresh = async () => {
    try {
      ...
      toast.error("Failed to refresh the project team calendar.");
    }
  };
      ...
      <div className="px-1 w-full mx-auto py-2 pb-6">
        ...
        <div className="flex flex-col md:flex-row md:items-start justify-between gap-4 mt-2">
          <div className="min-w-0">
            ...
            >
              Project Team <span className="font-bold">Leave Calendar</span>
            </h1>
...
export default ProjectTeamCalendarPage;
